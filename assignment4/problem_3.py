...
plt.plot(x,corshift(y,len(y)/10),label=r"$\frac{1}{10}$")
plt.plot(x,corshift(y,len(y)/8),label=r"$\frac{1}{8}$")
plt.plot(x,corshift(y,len(y)/6),label=r"$\frac{1}{6}$")
plt.plot(x,corshift(y,len(y)/4),label=r"$\frac{1}{4}$")
plt.plot(x,corshift(y,len(y)/2),label=r"$\frac{1}{2}$")
